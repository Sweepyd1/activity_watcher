#!/usr/bin/env python3
"""
Простой сервер для приема данных из ActivityWatch
...
# Модель для данных от ActivityWatch
...
@app.post("/receive_comprehensive")
...
@app.post("/receive_daily_summary")
